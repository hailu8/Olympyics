...
function plotTornado(data, selectYear, selectMedal) {
    ...
    if (selectMedal === "all-athletes") {
        console.log("Person 3 in All-Athlete Tor function for year " + selectYear + ", the time requested is" + " " + time3 + ", the server got it at time " + recieved + ", server took " + Total_time + " total time" + ", the server returned at " + finish_time + " time," + " time taken to execute is" + " " + execute_query_db + ", to loop through all rows " + loop_query_db + " time was taken");
    } else if (selectMedal === "all-medalists") {
        console.log("Person 3 in All-Medalist Tor function for year " + selectYear + ", the time requested is" + " " + time3 + ", the server got it at time " + Mrecieved + ", server took " + MTotal_time + " total time" + ", the server returned at " + Mfinish_time + " time," + " time taken to execute is" + " " + Mexecute_query_db + " to loop through all rows " + Mloop_query_db + " time was taken");
    } else {
        console.log("not in here");
    }
...
function updateMap(jsonFeature, getData, medalCountryData, allCountryData, selectYear, selectMedal) {
    ...
    console.log("Person 3 in map(PID) function for year " + selectYear + " the time requested is" + " " + time + ", the server got it at time " + recieved + ", server took " + Total_time + " total time" + ", the server returned at " + finish_time + " time" + ", time taken to execute(sql) is" + " " + execute_query_db + ", to loop through all rows " + loop_query_db + " time was taken");
    ...
    Scheme.on('click', (event, d) => {
            console.log("Person 3 looking at darker plot");
            if (selectMedal === 'all-athletes') {
    ...
    d3.select('#zoom-in').on('click', function() {
        // Smooth zooming
        console.log("Person 3 used zoom in");
        zoom.scaleBy(svg.transition().duration(750), 1.3);
    });

    d3.select('#zoom-out').on('click', function() {
        console.log("Person 3 used zoom out");
        // Ordinal zooming
        zoom.scaleBy(svg, 1 / 1.3);
    });

    d3.select('#resetMap').on('click', function() {
        console.log("Person 3 used reset button");
